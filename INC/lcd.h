...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define	LCD_LED PFout(13)  		//LCD背光    		 PF13 	    
//LCD地址结构体
...
void printActivePart();	//打印显示屏固定部分
void printFixedPart();	//打印显示屏变化部分
void LCD_ShowNum2(u16 x,u16 y,u32 num,u8 len,u8 size);	//打印数字
